...
/**
 * A set of functions called "actions" for `Platform`
 */
...
module.exports = {
  ...
  /**
   * Add an entry to a specific Platform.
   *
   * @return {Object}
   */
  ...
  /**
   * Remove a specific entry from a specific Platform.
   *
   * @return {Object}
   */
